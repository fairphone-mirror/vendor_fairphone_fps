...
VENDOR_FOREACH_WHITELIST = {
    "device/qcom/common/utils.mk",
    "device/qcom/volcano/volcano.mk",
    "device/qcom/wlan/volcano/BoardConfigWlan.mk",
    "device/qcom/wlan/volcano/wlan.mk",
    "vendor/qcom/opensource/audio-hal/primary-hal/configs/volcano/volcano.mk",
...
VENDOR_MACRO_WHITELIST = {
    ...
    "vendor/qcom/opensource/bt-kernel/bt_kernel_product_board.mk",
    "vendor/qcom/opensource/camera-kernel/product.mk",
}
...
VENDOR_SOONG_WHITELIST = {
    "device/qcom/volcano/BoardConfig.mk",
    "device/fairphone/fps/BoardConfig.mk",
